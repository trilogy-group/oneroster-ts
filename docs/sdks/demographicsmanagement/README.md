...
* [getAllDemographics](#getalldemographics) - Get all Demographic records
* [postDemographics](#postdemographics) - Create a new Demographic record
* [getDemographics](#getdemographics) - Get a specific Demographic record
* [putDemographics](#putdemographics) - Update a Demographic record
* [deleteDemographics](#deletedemographics) - Delete a Demographic record
...
async function run() {
  const result = await oneRoster.demographicsManagement.getAllDemographics({
...
import { demographicsManagementGetAllDemographics } from "@superbuilders/oneroster/funcs/demographicsManagementGetAllDemographics.js";
...
async function run() {
  const res = await demographicsManagementGetAllDemographics(oneRoster, {
    fields: "sourcedId,name",
    filter: "status='active'",
  });
  if (res.ok) {
    ...
    console.log("demographicsManagementGetAllDemographics failed:", res.error);
  }
}
...
async function run() {
  const result = await oneRoster.demographicsManagement.postDemographics();
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { demographicsManagementPostDemographics } from "@superbuilders/oneroster/funcs/demographicsManagementPostDemographics.js";
...
async function run() {
  const res = await demographicsManagementPostDemographics(oneRoster);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("demographicsManagementPostDemographics failed:", res.error);
  }
}
...
async function run() {
  const result = await oneRoster.demographicsManagement.getDemographics({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { demographicsManagementGetDemographics } from "@superbuilders/oneroster/funcs/demographicsManagementGetDemographics.js";
...
async function run() {
  const res = await demographicsManagementGetDemographics(oneRoster, {
    sourcedId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("demographicsManagementGetDemographics failed:", res.error);
  }
}
...
async function run() {
  const result = await oneRoster.demographicsManagement.putDemographics({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { demographicsManagementPutDemographics } from "@superbuilders/oneroster/funcs/demographicsManagementPutDemographics.js";
...
async function run() {
  const res = await demographicsManagementPutDemographics(oneRoster, {
    sourcedId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("demographicsManagementPutDemographics failed:", res.error);
  }
}
...
async function run() {
  await oneRoster.demographicsManagement.deleteDemographics({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { demographicsManagementDeleteDemographics } from "@superbuilders/oneroster/funcs/demographicsManagementDeleteDemographics.js";
...
async function run() {
  const res = await demographicsManagementDeleteDemographics(oneRoster, {
    sourcedId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("demographicsManagementDeleteDemographics failed:", res.error);
  }
}

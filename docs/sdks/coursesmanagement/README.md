...
* [getAllCourses](#getallcourses) - Get All Courses
* [createCourse](#createcourse) - Create a Course
* [getClassesForCourse](#getclassesforcourse) - Get Classes for a Course
* [getCourse](#getcourse) - Get a specific Course
* [putCourse](#putcourse) - Update a Course
* [deleteCourse](#deletecourse) - Delete a Course
* [createComponentResource](#createcomponentresource) - Create Component Resource
* [getAllComponentResources](#getallcomponentresources) - Get all Component Resources
* [getComponentResource](#getcomponentresource) - Get a specific Component Resource
* [putComponentResource](#putcomponentresource) - Update a Component Resource
* [deleteComponentResource](#deletecomponentresource) - Delete a Component Resource
...
<!-- UsageSnippet language="typescript" operationID="getAllCourses" method="get" path="/ims/oneroster/rostering/v1p2/courses/" -->
```typescript
...
async function run() {
  const result = await oneRoster.coursesManagement.getAllCourses({
...
import { coursesManagementGetAllCourses } from "@superbuilders/oneroster/funcs/coursesManagementGetAllCourses.js";
...
async function run() {
  const res = await coursesManagementGetAllCourses(oneRoster, {
    fields: "sourcedId,name",
    filter: "status='active'",
  });
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetAllCoursesRequest](../../models/operations/getallcoursesrequest.md)                                                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.GetAllCoursesResponse](../../models/operations/getallcoursesresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="createCourse" method="post" path="/ims/oneroster/rostering/v1p2/courses/" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementCreateCourse } from "@superbuilders/oneroster/funcs/coursesManagementCreateCourse.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.CreateCourseRequest](../../models/operations/createcourserequest.md)                                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.CreateCourseResponse](../../models/operations/createcourseresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getClassesForCourse" method="get" path="/ims/oneroster/rostering/v1p2/courses/{courseSourcedId}/classes" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.getClassesForCourse({
    courseSourcedId: "<id>",
    fields: "sourcedId,name",
    filter: "status='active'",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementGetClassesForCourse } from "@superbuilders/oneroster/funcs/coursesManagementGetClassesForCourse.js";
...
async function run() {
  const res = await coursesManagementGetClassesForCourse(oneRoster, {
    courseSourcedId: "<id>",
    fields: "sourcedId,name",
    filter: "status='active'",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetClassesForCourseRequest](../../models/operations/getclassesforcourserequest.md)                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetClassesForCourseResponse](../../models/operations/getclassesforcourseresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getCourse" method="get" path="/ims/oneroster/rostering/v1p2/courses/{sourcedId}" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.getCourse({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementGetCourse } from "@superbuilders/oneroster/funcs/coursesManagementGetCourse.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetCourseRequest](../../models/operations/getcourserequest.md)                                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetCourseResponse](../../models/operations/getcourseresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="putCourse" method="put" path="/ims/oneroster/rostering/v1p2/courses/{sourcedId}" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.putCourse({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementPutCourse } from "@superbuilders/oneroster/funcs/coursesManagementPutCourse.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PutCourseRequest](../../models/operations/putcourserequest.md)                                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="deleteCourse" method="delete" path="/ims/oneroster/rostering/v1p2/courses/{sourcedId}" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.deleteCourse({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementDeleteCourse } from "@superbuilders/oneroster/funcs/coursesManagementDeleteCourse.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.DeleteCourseRequest](../../models/operations/deletecourserequest.md)                                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="createComponentResource" method="post" path="/ims/oneroster/rostering/v1p2/courses/component-resources" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementCreateComponentResource } from "@superbuilders/oneroster/funcs/coursesManagementCreateComponentResource.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.CreateComponentResourceRequest](../../models/operations/createcomponentresourcerequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.CreateComponentResourceResponse](../../models/operations/createcomponentresourceresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getAllComponentResources" method="get" path="/ims/oneroster/rostering/v1p2/courses/component-resources" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.getAllComponentResources({
    fields: "sourcedId,name",
    filter: "status='active'",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementGetAllComponentResources } from "@superbuilders/oneroster/funcs/coursesManagementGetAllComponentResources.js";
...
async function run() {
  const res = await coursesManagementGetAllComponentResources(oneRoster, {
    fields: "sourcedId,name",
    filter: "status='active'",
  });
  if (res.ok) {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetAllComponentResourcesRequest](../../models/operations/getallcomponentresourcesrequest.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetAllComponentResourcesResponse](../../models/operations/getallcomponentresourcesresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getComponentResource" method="get" path="/ims/oneroster/rostering/v1p2/courses/component-resources/{sourcedId}" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.getComponentResource({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementGetComponentResource } from "@superbuilders/oneroster/funcs/coursesManagementGetComponentResource.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetComponentResourceRequest](../../models/operations/getcomponentresourcerequest.md)                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetComponentResourceResponse](../../models/operations/getcomponentresourceresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="putComponentResource" method="put" path="/ims/oneroster/rostering/v1p2/courses/component-resources/{sourcedId}" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.putComponentResource({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementPutComponentResource } from "@superbuilders/oneroster/funcs/coursesManagementPutComponentResource.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PutComponentResourceRequest](../../models/operations/putcomponentresourcerequest.md)                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="deleteComponentResource" method="delete" path="/ims/oneroster/rostering/v1p2/courses/component-resources/{sourcedId}" -->
```typescript
import { OneRoster } from "@superbuilders/oneroster";
...
async function run() {
  const result = await oneRoster.coursesManagement.deleteComponentResource({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { coursesManagementDeleteComponentResource } from "@superbuilders/oneroster/funcs/coursesManagementDeleteComponentResource.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.DeleteComponentResourceRequest](../../models/operations/deletecomponentresourcerequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await oneRoster.coursesManagement.createCourseComponent({
    courseComponent: {
      status: "active",
      course: {
        sourcedId: "<id>",
...
async function run() {
  const result = await oneRoster.coursesManagement.getAllCourseComponents({
    fields: "sourcedId,name",
    filter: "status='active'",
  });
...
async function run() {
  const result = await oneRoster.coursesManagement.getCourseComponent({
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.coursesManagement.putCourseComponent({
    sourcedId: "<id>",
    requestBody: {
      courseComponent: {
        status: "tobedeleted",
...
async function run() {
  const result = await oneRoster.coursesManagement.deleteCourseComponent({
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.coursesManagement.getCoursesForSchool({
    schoolSourcedId: "<id>",
    fields: "sourcedId,name",
    filter: "status='active'",
  });

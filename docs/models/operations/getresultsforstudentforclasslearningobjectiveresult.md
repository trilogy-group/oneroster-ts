...
```typescript
import { GetResultsForStudentForClassLearningObjectiveResult } from "@superbuilders/oneroster/models/operations";

let value: GetResultsForStudentForClassLearningObjectiveResult = {

 ...
 */
export function coursesManagementGetClassesForCourse(
  ...
  PageIterator<
    Result<
      operations.GetClassesForCourseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetClassesForCourseRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetClassesForCourseResponse$inboundSchema, {
      key: "Result",
    }),

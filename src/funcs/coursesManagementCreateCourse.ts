 ...
 */
export function coursesManagementCreateCourse(
  client: OneRosterCore,
  request?: operations.CreateCourseRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateCourseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateCourseRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/courses/")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateCourseResponse$inboundSchema),

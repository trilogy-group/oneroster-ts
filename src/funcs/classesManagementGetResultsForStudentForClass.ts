 ...
 */
export function classesManagementGetResultsForStudentForClass(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetResultsForStudentForClassRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    studentSourcedId: encodeSimple(
      "studentSourcedId",
      payload.studentSourcedId,

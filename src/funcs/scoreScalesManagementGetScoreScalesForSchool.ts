 ...
 */
export function scoreScalesManagementGetScoreScalesForSchool(
  ...
  PageIterator<
    Result<
      operations.GetScoreScalesForSchoolResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetScoreScalesForSchoolRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScoreScalesForSchoolResponse$inboundSchema, {
      key: "Result",
    }),

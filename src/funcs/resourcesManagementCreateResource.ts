 ...
 */
export function resourcesManagementCreateResource(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateResourceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateResourceResponse$inboundSchema),

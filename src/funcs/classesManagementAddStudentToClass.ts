 ...
 */
export function classesManagementAddStudentToClass(
  client: OneRosterCore,
  request: operations.AddStudentToClassRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddStudentToClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddStudentToClassRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.AddStudentToClassResponse$inboundSchema),

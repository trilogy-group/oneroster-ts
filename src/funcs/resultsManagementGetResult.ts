 ...
 */
export function resultsManagementGetResult(
  client: OneRosterCore,
  request: operations.GetResultRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetResultResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetResultRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetResultResponse$inboundSchema),

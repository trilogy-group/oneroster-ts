 ...
 */
export function organizationsManagementGetAllOrgs(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllOrgsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/orgs/")();

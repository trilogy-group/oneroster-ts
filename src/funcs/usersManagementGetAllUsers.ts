 ...
 */
export function usersManagementGetAllUsers(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/users/")();

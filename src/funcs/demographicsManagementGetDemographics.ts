 ...
 */
export function demographicsManagementGetDemographics(
  client: OneRosterCore,
  request: operations.GetDemographicsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDemographicsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDemographicsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDemographicsResponse$inboundSchema),

 ...
 */
export function assessmentLineItemsManagementGetAssessmentLineItem(
  client: OneRosterCore,
  request: operations.GetAssessmentLineItemRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAssessmentLineItemResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAssessmentLineItemRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAssessmentLineItemResponse$inboundSchema),

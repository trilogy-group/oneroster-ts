 ...
 */
export function teachersManagementGetAllTeachers(
  ...
  PageIterator<
    Result<
      operations.GetAllTeachersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllTeachersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/teachers/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllTeachersResponse$inboundSchema, {
      key: "Result",
    }),

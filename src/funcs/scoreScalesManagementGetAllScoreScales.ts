 ...
 */
export function scoreScalesManagementGetAllScoreScales(
  ...
  PageIterator<
    Result<
      operations.GetAllScoreScalesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllScoreScalesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/gradebook/v1p2/scoreScales/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllScoreScalesResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "scoreScales");

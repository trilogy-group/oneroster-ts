 ...
 */
export function gradingPeriodsManagementGetGradingPeriod(
  client: OneRosterCore,
  request: operations.GetGradingPeriodRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGradingPeriodResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGradingPeriodRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGradingPeriodResponse$inboundSchema),

 ...
 */
export function coursesManagementGetComponentResource(
  client: OneRosterCore,
  request: operations.GetComponentResourceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetComponentResourceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetComponentResourceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetComponentResourceResponse$inboundSchema),

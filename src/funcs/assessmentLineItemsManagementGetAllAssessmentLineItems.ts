 ...
 */
export function assessmentLineItemsManagementGetAllAssessmentLineItems(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllAssessmentLineItemsRequest$outboundSchema.parse(value),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "assessmentLineItems");

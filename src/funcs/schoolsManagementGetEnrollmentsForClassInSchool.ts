 ...
 */
export function schoolsManagementGetEnrollmentsForClassInSchool(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetEnrollmentsForClassInSchoolRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetEnrollmentsForClassInSchoolResponse$inboundSchema,
      { key: "Result" },
    ),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "enrollments");

 ...
 */
export function termsManagementCreateGradingPeriodForTerm(
  client: OneRosterCore,
  request: operations.CreateGradingPeriodForTermRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGradingPeriodForTermResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateGradingPeriodForTermRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateGradingPeriodForTermResponse$inboundSchema),

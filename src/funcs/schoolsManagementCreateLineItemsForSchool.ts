 ...
 */
export function schoolsManagementCreateLineItemsForSchool(
  client: OneRosterCore,
  request: operations.CreateLineItemsForSchoolRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateLineItemsForSchoolResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateLineItemsForSchoolRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateLineItemsForSchoolResponse$inboundSchema),

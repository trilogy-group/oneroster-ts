 ...
 */
export function classesManagementGetClass(
  client: OneRosterCore,
  request: operations.GetClassRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetClassResponse,
...
> {
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/classes/{sourcedId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetClassResponse$inboundSchema),

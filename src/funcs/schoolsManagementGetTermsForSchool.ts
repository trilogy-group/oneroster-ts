 ...
 */
export function schoolsManagementGetTermsForSchool(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTermsForSchoolRequest$outboundSchema.parse(value),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "terms");

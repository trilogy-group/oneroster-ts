 ...
 */
export function classesManagementGetAllClasses(
  ...
  PageIterator<
    Result<
      operations.GetAllClassesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllClassesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/classes/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllClassesResponse$inboundSchema, {
      key: "Result",
    }),

 ...
 */
export function classesManagementGetResultsForLineItemForClass(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetResultsForLineItemForClassRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    lineItemSourcedId: encodeSimple(
      "lineItemSourcedId",
      payload.lineItemSourcedId,

 ...
 */
export function schoolsManagementGetLineItemsForSchool(
  ...
  PageIterator<
    Result<
      operations.GetLineItemsForSchoolResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetLineItemsForSchoolRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetLineItemsForSchoolResponse$inboundSchema, {
      key: "Result",
    }),

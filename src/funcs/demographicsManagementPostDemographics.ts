 ...
 */
export function demographicsManagementPostDemographics(
  client: OneRosterCore,
  request?: operations.PostDemographicsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostDemographicsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostDemographicsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostDemographicsResponse$inboundSchema),

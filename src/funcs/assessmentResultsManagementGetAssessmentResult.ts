 ...
 */
export function assessmentResultsManagementGetAssessmentResult(
  client: OneRosterCore,
  request: operations.GetAssessmentResultRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAssessmentResultResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAssessmentResultRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAssessmentResultResponse$inboundSchema),

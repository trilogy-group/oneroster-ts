 ...
 */
export function schoolsManagementCreateSchool(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateSchoolRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/schools/")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.Org$inboundSchema),

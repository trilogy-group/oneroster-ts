 ...
 */
export function termsManagementGetAllTerms(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllTermsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/terms/")();

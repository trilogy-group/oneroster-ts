 ...
 */
export function classesManagementGetTeachersForClass(
  ...
  PageIterator<
    Result<
      operations.GetTeachersForClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTeachersForClassRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTeachersForClassResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "teachers");

 ...
 */
export function resourcesManagementExportResourceToCommonCartridge(
  client: OneRosterCore,
  request: operations.ExportResourceToCommonCartridgeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExportResourceToCommonCartridgeResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExportResourceToCommonCartridgeRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.stream(
      200,
      operations.ExportResourceToCommonCartridgeResponse$inboundSchema,
    ...
    M.jsonErr([400, 404], errors.NotFoundResponseError$inboundSchema),

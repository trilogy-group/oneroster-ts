 ...
 */
export function schoolsManagementGetCoursesForSchool(
  ...
  PageIterator<
    Result<
      operations.GetCoursesForSchoolResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCoursesForSchoolRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCoursesForSchoolResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "courses");

 ...
 */
export function coursesManagementGetCourseComponent(
  client: OneRosterCore,
  request: operations.GetCourseComponentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCourseComponentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCourseComponentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCourseComponentResponse$inboundSchema),

 ...
 */
export function studentsManagementGetAllStudents(
  ...
  PageIterator<
    Result<
      operations.GetAllStudentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllStudentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/students/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllStudentsResponse$inboundSchema, {
      key: "Result",
    }),

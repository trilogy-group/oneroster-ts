 ...
 */
export function classesManagementGetClassesForTeacher(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetClassesForTeacherRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    teacherSourcedId: encodeSimple(
      "teacherSourcedId",
      payload.teacherSourcedId,

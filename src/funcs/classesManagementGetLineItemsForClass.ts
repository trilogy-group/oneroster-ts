 ...
 */
export function classesManagementGetLineItemsForClass(
  ...
  PageIterator<
    Result<
      operations.GetLineItemsForClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetLineItemsForClassRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetLineItemsForClassResponse$inboundSchema, {
      key: "Result",
    }),

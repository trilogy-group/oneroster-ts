 ...
 */
export function coursesManagementGetAllComponentResources(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllComponentResourcesRequest$outboundSchema.parse(value),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "componentResources");

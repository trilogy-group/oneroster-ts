 ...
 */
export function resultsManagementUpdateResult(
  client: OneRosterCore,
  request: operations.UpdateResultRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateResultResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateResultRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/gradebook/v1p2/results/{sourcedId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateResultResponse$inboundSchema),

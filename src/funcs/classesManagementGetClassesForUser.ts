 ...
 */
export function classesManagementGetClassesForUser(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetClassesForUserRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetClassesForUserResponse$inboundSchema, {
      key: "Result",
    }),

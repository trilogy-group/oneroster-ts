 ...
 */
export function scoreScalesManagementCreateScoreScale(
  client: OneRosterCore,
  request: operations.CreateScoreScaleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateScoreScaleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateScoreScaleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateScoreScaleResponse$inboundSchema),

 ...
 */
export function schoolsManagementUpdateSchool(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateSchoolRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/schools/{sourcedId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Org$inboundSchema),

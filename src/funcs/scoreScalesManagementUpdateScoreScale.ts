 ...
 */
export function scoreScalesManagementUpdateScoreScale(
  client: OneRosterCore,
  request: operations.UpdateScoreScaleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateScoreScaleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateScoreScaleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateScoreScaleResponse$inboundSchema),

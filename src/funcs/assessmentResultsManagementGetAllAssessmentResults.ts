 ...
 */
export function assessmentResultsManagementGetAllAssessmentResults(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllAssessmentResultsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/gradebook/v1p2/assessmentResults/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllAssessmentResultsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "assessmentResults");

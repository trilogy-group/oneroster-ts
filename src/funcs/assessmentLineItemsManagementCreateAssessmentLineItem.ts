 ...
 */
export function assessmentLineItemsManagementCreateAssessmentLineItem(
  client: OneRosterCore,
  request: operations.CreateAssessmentLineItemRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateAssessmentLineItemResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateAssessmentLineItemRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateAssessmentLineItemResponse$inboundSchema),

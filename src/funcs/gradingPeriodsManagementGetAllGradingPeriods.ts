 ...
 */
export function gradingPeriodsManagementGetAllGradingPeriods(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllGradingPeriodsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/gradingPeriods/")();

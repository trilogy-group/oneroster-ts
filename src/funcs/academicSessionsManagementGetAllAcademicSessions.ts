 ...
 */
export function academicSessionsManagementGetAllAcademicSessions(
  ...
  PageIterator<
    Result<
      operations.GetAllAcademicSessionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllAcademicSessionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/academicSessions/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllAcademicSessionsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "academicSessions");

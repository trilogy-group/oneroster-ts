 ...
 */
export function enrollmentsManagementCreateEnrollment(
  client: OneRosterCore,
  request?: operations.CreateEnrollmentRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateEnrollmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateEnrollmentRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateEnrollmentResponse$inboundSchema),

 ...
 */
export function resourcesManagementGetAllResources(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllResourcesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/resources/v1p2/resources/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllResourcesResponse$inboundSchema, {
      key: "Result",
    }),

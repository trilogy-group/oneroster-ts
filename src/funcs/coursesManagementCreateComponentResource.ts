 ...
 */
export function coursesManagementCreateComponentResource(
  client: OneRosterCore,
  request?: operations.CreateComponentResourceRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateComponentResourceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateComponentResourceRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateComponentResourceResponse$inboundSchema),

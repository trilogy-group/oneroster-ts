 ...
 */
export function classesManagementGetStudentsForClass(
  ...
  PageIterator<
    Result<
      operations.GetStudentsForClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStudentsForClassRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStudentsForClassResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "students");

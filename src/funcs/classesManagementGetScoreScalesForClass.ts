 ...
 */
export function classesManagementGetScoreScalesForClass(
  ...
  PageIterator<
    Result<
      operations.GetScoreScalesForClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetScoreScalesForClassRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScoreScalesForClassResponse$inboundSchema, {
      key: "Result",
    }),

 ...
 */
export function classesManagementGetCategoriesForClass(
  ...
  PageIterator<
    Result<
      operations.GetCategoriesForClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCategoriesForClassRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCategoriesForClassResponse$inboundSchema, {
      key: "Result",
    }),

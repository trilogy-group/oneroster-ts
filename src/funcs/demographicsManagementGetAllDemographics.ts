 ...
 */
export function demographicsManagementGetAllDemographics(
  ...
  PageIterator<
    Result<
      operations.GetAllDemographicsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllDemographicsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/demographics/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllDemographicsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const results = dlv(responseData, "demographics");

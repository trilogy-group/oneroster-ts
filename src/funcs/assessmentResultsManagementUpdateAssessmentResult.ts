 ...
 */
export function assessmentResultsManagementUpdateAssessmentResult(
  client: OneRosterCore,
  request: operations.UpdateAssessmentResultRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateAssessmentResultResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateAssessmentResultRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateAssessmentResultResponse$inboundSchema),

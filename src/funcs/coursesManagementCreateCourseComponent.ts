 ...
 */
export function coursesManagementCreateCourseComponent(
  client: OneRosterCore,
  request?: operations.CreateCourseComponentRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateCourseComponentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateCourseComponentRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateCourseComponentResponse$inboundSchema),

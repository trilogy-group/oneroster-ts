 ...
 */
export function demographicsManagementPutDemographics(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PutDemographicsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Demographics$inboundSchema),

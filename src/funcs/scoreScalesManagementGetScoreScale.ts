 ...
 */
export function scoreScalesManagementGetScoreScale(
  client: OneRosterCore,
  request: operations.GetScoreScaleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetScoreScaleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetScoreScaleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScoreScaleResponse$inboundSchema),

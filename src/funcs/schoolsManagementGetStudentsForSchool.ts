 ...
 */
export function schoolsManagementGetStudentsForSchool(
  ...
  PageIterator<
    Result<
      operations.GetStudentsForSchoolResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStudentsForSchoolRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStudentsForSchoolResponse$inboundSchema, {
      key: "Result",
    }),

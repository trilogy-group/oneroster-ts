 ...
 */
export function usersManagementGetUserWithDemographics(
  client: OneRosterCore,
  request: operations.GetUserWithDemographicsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetUserWithDemographicsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetUserWithDemographicsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUserWithDemographicsResponse$inboundSchema),

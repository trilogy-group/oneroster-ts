 ...
 */
export function lineItemsManagementCreateResultForLineItem(
  client: OneRosterCore,
  request: operations.CreateResultForLineItemRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateResultForLineItemResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateResultForLineItemRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateResultForLineItemResponse$inboundSchema),

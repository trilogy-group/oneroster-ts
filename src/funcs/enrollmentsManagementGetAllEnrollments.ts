 ...
 */
export function enrollmentsManagementGetAllEnrollments(
  ...
  PageIterator<
    Result<
      operations.GetAllEnrollmentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllEnrollmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/rostering/v1p2/enrollments/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllEnrollmentsResponse$inboundSchema, {
      key: "Result",
    }),

 ...
 */
export function resultsManagementGetAllResults(
  ...
  PageIterator<
    Result<
      operations.GetAllResultsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllResultsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/ims/oneroster/gradebook/v1p2/results/")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllResultsResponse$inboundSchema, {
      key: "Result",
    }),

 ...
 */
export function academicSessionsManagementPostAcademicSession(
  client: OneRosterCore,
  request?: operations.PostAcademicSessionRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostAcademicSessionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostAcademicSessionRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostAcademicSessionResponse$inboundSchema),
